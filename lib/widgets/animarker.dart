...
class AnimarkerState extends State<Animarker> with TickerProviderStateMixin {
  ...
  void didUpdateWidget(Animarker oldWidget) {
    ...
    if(widget.duration!=oldWidget.duration){
      ...
      // _controller.description=AnimarkerControllerDescription.animarker(
      //   widget,
      //   vsync: this,
      //   onStopover: _onStopover,
      //   onRippleAnimation: _rippleListener,
      //   onMarkerAnimation: _locationListener,
      // );
      // _controller.description.setDuration=widget.duration;
      // description.setDuration(widget.duration);

      print("NEw update widget -=======>> ${widget.duration}");
      setState(() {
